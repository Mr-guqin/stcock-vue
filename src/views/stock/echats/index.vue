<template>
  <div ref="shiDenChartDom" style="width: 1000px; height: 800px;"></div>
</template>

<script setup>
import {onMounted, onUnmounted, ref} from 'vue';
import * as echarts from 'echarts';
import {queryFenShiLineByStockNo} from "@/api/stock/stockKLine.js";

// 创建一个响应式引用来保存DOM元素
const shiDenChartDom = ref(null);
let shifenChartInstance = null;

// const shifenUpColor = '#ec0000';
// const shifenDownColor = '#00da3c';
...
function draw() {
  ...
  queryFenShiLineByStockNo(stockNo).then(response => {
    ...
    const option = initMOption(data1, 'hs');
...
function initKOption(cdata) {
  ...
  return {
    ...
    series: [{
      ...
      itemStyle: {
        normal: {
          color: shifenUpColor, //fd2e2e  ff4242
